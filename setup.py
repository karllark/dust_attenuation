...
PACKAGENAME = metadata.get('package_name', 'dust_attenuation')
DESCRIPTION = metadata.get('description', 'Astronomical dust attenuation models')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: dust_attenuation requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
